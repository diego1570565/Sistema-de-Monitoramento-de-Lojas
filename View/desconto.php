                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <input type="number" style='width:15%' placeholder="PDV" id="Cod_pdv" name='Cod_pdv'
                                class="m-2 form-control" style ='width:20%' ">
                            </input>
...
<script>
    ...
    function pesquisar() {
        if (Cod_loja1 == false && Data_movimentacaoInicio == false && Data_movimentacaoFim == false && Cod_pdv1 == false) {
            ...
            $('#dados').load('../PHP/desconto.php?Cod_loja=' + valCod_loja + '&Cod_pdv=' + valCod_pdv + '&Data_Inicio=' + valDataInicio  + '&Data_Fim=' + valDataFim)
        }
    }
