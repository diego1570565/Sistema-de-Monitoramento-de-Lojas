    ...
    function pesquisar() {
        if (Cod_loja1 == false && Data_movimentacaoInicio == false && Data_movimentacaoFim == false && Cod_pdv1 == false) {
            ...
            requisitarPagina('../Controller/cancelamento_item.php?Nome=' + nome)
            $('#ocultar').load('../Assets/filtro_pessoas/filtro_pessoa_cancelamento_item.php')
            ...
            requisitarPagina('../Controller/cancelamento_item.php?Cod_loja=' + 
            valCod_loja + '&Cod_pdv=' + valCod_pdv + '&Nomes=' + nome + 
            '&Data_Inicio=' + valDataInicio  + '&Data_Fim=' + valDataFim )
            
            $('#ocultar').load('../Assets/filtro_pessoas/filtro_pessoa_cancelamento_item.php?Cod_loja=' + valCod_loja + 
