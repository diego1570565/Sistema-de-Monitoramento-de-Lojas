...
function verificaprocessos() {
    ...
    if (editar == true) {
        ...
        var perda_ganho_processos = $('#perda_ganho_processos').val()
        var processo_auditado_processos = $('#processo_auditado_processos').val()
        var setor_processos = $('#setor_processos').val()
        var evidencia_processos = $('#evidencia_processos').val()
        var observacao_processos = $('#observacao_processos').val()
        var data_hora_processos = $('#data_hora_processos').val()
        var filial_id_processos = $('#filial_id_processos').val()
        var data_repassado_processos = $('#data_repassado_processos').val()
    
    
        if (sessionStorage.getItem('central')) {
            if (perda_ganho_processos != '' &&
                processo_auditado_processos != '' &&
                setor_processos != '' &&
                evidencia_processos != '' &&
                observacao_processos != '' &&
                data_hora_processos != '' &&
                filial_id_processos != '' &&
                data_repassado_processos != '') {
                verificacao = true;
            }
        }
    
        if (sessionStorage.getItem('gerente')) {
            if (typeof $('#imagem_processos')[0].files[0] != "undefined" && $('#descritivo_retorno_loja_processos').val() == 1) {
                verificacao = true
            }else{
                verificacao = false
            }
    
            if($('#descritivo_retorno_loja_processos').val() == 2){
                verificacao = true
            }
        }
        ...
        if (verificacao == true) {
            ...
            $.ajax({
                type: "POST",
                url: "Controller/Update_processos.php",
                data: {
                    numcontrole: (fluxoAuditoria.NUMCONTROLE),
                    perda_ganho_processos: $('#perda_ganho_processos').val(),
                    processo_auditado_processos: $('#processo_auditado_processos').val(),
                    setor_processos: $('#setor_processos').val(),
                    evidencia_processos: $('#evidencia_processos').val(),
                    observacao_processos: $('#observacao_processos').val(),
                    data_hora_processos: $('#data_hora_processos').val(),
                    filial_id_processos: $('#filial_id_processos').val(),
                    data_repassado_processos: $('#data_repassado_processos').val(),
                    descritivo_retorno_loja_processos: $('#descritivo_retorno_loja_processos').val(),
                    dataalteracao: true
                },
                success: function (response) {
                    ...
                    form_data.append('imagem', $('#imagem_processos')[0].files[0]);
    ...
    enableAllInputs('nao')
    $('*').removeClass('vazio')
    $('#editar_processos').attr('disabled', true)
    ...
    $('#observacao_processos').attr('disabled', false);
    ...
    $('#numero_nota').attr('disabled', true);
    ...
    if (editar == true) {
        ...
        } else if ((sessionStorage.getItem('prevencao') == 'true' && $("#numero_nota").val() != '' && $("#descritivo_retorno_prevencao").val() != '') == true
            || (sessionStorage.getItem('prevencao') != 'true' && $("#minuta").val() != '' && $("#evidencia").val() != '' && $("#perda_ganho").val() != '' && $("#data_repassado").val() != '' && $("#quantidade").val() != '' && $("#valor_unidade").val() != '') == true) {
            event.preventDefault();
            $.ajax({
                type: "POST",
                url: "Controller/Update.php",
    ...
    if (atr == 'sim') {
        ...
        $('#label_imagem_processos').removeClass('transparente');
        ...
        $("#cancelar_processos").attr('disabled', true)
        $("#editar_processos").attr('disabled', true)
        $("#salvar_processos").attr('disabled', true)
        $("#filial_id_processos").attr('disabled', true)
        $("#perda_ganho_processos").attr('disabled', true)
        $("#data_repassado_processos").attr('disabled', true)
        $("#descritivo_retorno_loja_processos").attr('disabled', true)
        $("#evidencia_processos").attr('disabled', true)
        $("#data_hora_processos").attr('disabled', true)
        $("#observacao_processos").attr('disabled', true)
        $("#setor_processos").attr('disabled', true)
        $("#processo_auditado_processos").attr('disabled', true)
        ...
        disableAllInputs();
        if (sessionStorage.getItem('gerente') == 'true') {
            $("#descritivo_retorno_loja_processos").attr('disabled', false)
            $('#label_imagem_processos').removeClass('transparente');
            $("#imagem_processos").attr('disabled', false)
            $("#cancelar_processos").attr('disabled', false)
            $("#salvar_processos").attr('disabled', false)
        }else{
            $("#cancelar_processos").attr('disabled', false)
            $("#salvar_processos").attr('disabled', false)
            $("#filial_id_processos").attr('disabled', false)
            $("#perda_ganho_processos").attr('disabled', false)
            $("#data_repassado_processos").attr('disabled', false)
            $("#evidencia_processos").attr('disabled', false)
            $("#data_hora_processos").attr('disabled', false)
            $("#observacao_processos").attr('disabled', false)
            $("#setor_processos").attr('disabled', false)
            $("#processo_auditado_processos").attr('disabled', false)
        }
    }else{
    if (sessionStorage.getItem('gerente') == 'true') {
        disableAllInputs();
    ...
    $("#numero_nota").removeClass('vazio')
    if (sessionStorage.getItem('prevencao') == 'true' && sessionStorage.getItem('central') == 'false') {
    ...
    function enableAllInputs(atr) {
        ...
        if (atr == 'sim') {
            ...
            if (sessionStorage.getItem('prevencao') == 'true') {
                ...
                $('#data_repasse_prevencao').attr('disabled', false);
                $('#descritivo_retorno_prevencao').attr('disabled', false);
                $('#numero_nota').attr('disabled', false);
            } else {
                $('#data_repasse_prevencao').attr('disabled', true);
                $('#descritivo_retorno_prevencao').attr('disabled', true);
                $('#numero_nota').attr('disabled', true);
        ...
        if (sessionStorage.getItem('auditor_fiscal_central') == 'true') {
        ...
        if (sessionStorage.getItem('auditor_processos') == 'true') {
        ...
        sessionStorage.setItem("Fluxo_Auditoria" , '')
        
        sessionStorage.setItem("Fluxo_Auditoria_Processos" , '')
        ...
        function trocar_nome_filial() {
            ...
            for (i = 0; i < itens.length; i++) {
                $('.codfilial_' + itens[i]['codfilial']).text(itens[i]['nome']);
            }
        }
        trocar_nome_filial()
    ...
    if (sessionStorage.getItem('prevencao') == 'true') {
        $('#minuta').removeClass('vazio');
    }
    
    function verifica_editar() {
    
    if (editar != true && $("#perda_ganho").val() != 'G' && $('#minuta').val() == '') {
        event.preventDefault();
        Swal.fire({
        icon: 'info',
        title: 'Inserção não realizada!',
    ...
    if (editar == true) {
        ...
        ||  (sessionStorage.getItem('prevencao') == 'true' && $("#perda_ganho").val() == 'G' && $("#descritivo_retorno_prevencao").val() != '') == true
        ||  (sessionStorage.getItem('prevencao') != 'true' && $("#minuta").val() !=''  && $("#evidencia").val() != '' && $("#perda_ganho").val() != '' && $("#data_repassado").val() != ''&& $("#quantidade").val() != '' && $("#valor_unidade").val() != '') == true
        ||  (sessionStorage.getItem('prevencao') != 'true'  && $("#evidencia").val() != '' && $("#perda_ganho").val() == 'G' && $("#data_repassado").val() != ''&& $("#quantidade").val() != '' && $("#valor_unidade").val() != '') == true)
